...
const Credits = () => {
  return (
    <>
      <SEOHead
        title="Website Credits | SPARK IUCEE RVCE"
        description="Meet the developers and designers who built the SPARK IUCEE RVCE website at RV College of Engineering, Bengaluru."
        path="/credits"
      />
